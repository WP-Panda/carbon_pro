...
jQuery(document).ready(function() {
	...
	jQuery('.item_icon_select').click(function(e) {
		...
		jQuery('#cr-font-modal-box').slideDown();
		e.preventDefault();
		return false;
	});

	jQuery(document).click(function(){
		jQuery('#cr-font-modal-box').slideUp();
	});
	jQuery('#cr-font-modal-box').click(function(e){
		e.stopPropagation();
	});
	jQuery('#cr-font-modal-box li').click(function(e) {
