                                        ...
                                        <tr>
                                            <td class="mcnImageContent" valign="top"
                                                ...
                                                <img align="center" alt=""
                                                     src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/08/MMLogoKreis_vector.svg"
                                                     width="196"
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
            ...
            <tr>
                <td valign="top" class="bodyContainer">
                    ...
                    <table class="wpp-divider mcnDividerBlock" border="0" cellpadding="0" cellspacing="0" width="100%"
                           style="min-width:100%;">
                    ...
                    <table class="wpp-product-block mcnImageGroupBlock" border="0" cellpadding="0" cellspacing="0"
                           width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" class="mcnTextContent"
                                            ...
                                            <p>Start by replacing the full-width header and main
                                                images with your own, or use a <a
                                                        href="https://mailchimp.com/help/view-and-edit-section-design/"
                                                        class="mc-template-link" target="parent">solid
                                                    color background</a>.</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td align="center" valign="middle" class="mcnButtonContent"
                                            ...
                                            <a class="mcnButton " title="Find Out More" href="#"
                                               target="_blank"
